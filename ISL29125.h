...
// CONFIG1
// Pick a mode, determines what color[s] the ISL29125 samples, if any
...
// Light intensity range: In a dark environment 375Lux is best,
// otherwise 10KLux is likely the best option
#define ISL_CFG1_375LUX                   0x00
#define ISL_CFG1_10KLUX                   0x08

// Change this to 12 bit if you want less accuracy, but faster ISL29125 reads
// At default 16 bit, each ISL29125 sample for a given color is about ~100ms
#define ISL_CFG1_16BIT                    0x00
#define ISL_CFG1_12BIT                    0x10

// Unless you want the interrupt pin to be an input that
// triggers ISL29125 sampling, leave this on normal
...
// How many times a ISL29125 sample must hit a threshold before
// triggering an interrupt
// More consecutive samples means more times between interrupts,
...
// If you would rather have interrupts trigger when a
// ISL29125 sampling is complete, enable this
// If this is disabled, interrupts are based on comparing
// ISL29125 data to threshold settings
